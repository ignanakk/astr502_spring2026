# -*- coding: utf-8 -*-
"""
Created on Thu Feb 12 11:19:09 2026
...
eso = Eso()
query = 'WASP-136' # find from target list (on Dr. Mann repo)
instrument = 'HARPS' # HARPS, UVES, ESPRESSO, FEROS
...
if len(downloaded) > 0:
    ...
    print("Error: No files were downloaded. Check if the ARCFILE is valid.")
...
plt.suptitle(f'\nNormalized Continuum Around Key Spectral Features for {star}', fontsize=16)
